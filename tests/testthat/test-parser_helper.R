test_that("test functionality of parse_to_df", {
  ...
  json_string_1 <- '{"gemeinden":[{"gemeinde_code":111,"gemeinde_name":"Bäretswil"}]}'
  json_string_2 <- '{"gemeinden":[{"gemeinde_code":112,"gemeinde_name":"Bubikon"}]}'
